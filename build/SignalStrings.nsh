...
LangString signalMinAppVersionErr 1043 "Er is al een nieuwere versie van Signal geïnstalleerd. Weet je zeker dat je door wilt gaan?"
# da_DK
...
LangString signalMinAppVersionErr 1030 "En nyere udgave af Signal er allerede installeret. Er du sikker på, at du vil fortsætte?"
# sv_SE
...
LangString signalMinAppVersionErr 1035 "Signalin uudempi versio on jo asennettu. Haluatko varmasti jatkaa?"
# ru_RU
...
LangString signalMinAppVersionErr 1049 "Более новая версия Signal уже установлена. Вы действительно хотите продолжить?"
# pt_PT
...
LangString signalMinAppVersionErr 2070 "Uma versão mais recente do Signal já está instalada. Tem a certeza de que quer continuar?"
# pt_BR
...
LangString signalMinAppVersionErr 1051 "Už je nainštalovaná novšia verzia Signalu. Naozaj chcete pokračovať?"
# hu_HU
...
LangString signalMinAppVersionErr 1054 "มีการติดตั้ง Signal เวอร์ชันที่ใหม่กว่าไว้แล้ว คุณแน่ใจหรือไม่ว่าต้องการดำเนินการต่อ"
# vi_VN
...
LangString signalMinAppVersionErr 1066 "Đã có phiên bản mới hơn của Signal được cài đặt. Bạn có chắc muốn tiếp tục?"
